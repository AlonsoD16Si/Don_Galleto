...
export class CocinaComponent {
  ...
  // Suscribirse al servicio de notificación de galletas agotadas
  constructor(private notificacionesService: NotificacionesService) {
    this.notificacionesService.galletaAgotada$.subscribe((nombreGalleta) => {
      alert(`¡Atención! La galleta "${nombreGalleta}" se ha agotado. Por favor, proceder con la producción.`);
    });
  }
